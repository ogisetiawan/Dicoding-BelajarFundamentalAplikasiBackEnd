...
class PlaylistsSongsService {
    ...
    async addSongToPlaylist(playlistId, songId) {
        ...
        if (!songResult.rowCount) {
            throw new NotFoundError('Song failed to add');
        }
    ...
    async getSongsFromPlaylist(playlistId) {
        ...
        if (!songResult.rowCount) {
            throw new NotFoundError('Lagu not found');
        }
    ...
    async deleteSongFromPlaylist(playlistId, songId) {
        ...
        if (!result.rowCount) {
            throw new InvariantError('Playlist song failed to delete, playlist id and song id not found');
        }
    }
}
